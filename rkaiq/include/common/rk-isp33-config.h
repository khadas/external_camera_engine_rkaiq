...
struct isp33_bay3d_cfg {
    ...
    __u8 md_large_lo_min_filter_en;
    __u8 md_large_lo_gauss_filter_en;
    __u8 md_large_lo_md_wgt_en;
    __u8 pre_ddr_out_mode;
    __u8 lpf_hi_en;
    __u8 lo_diff_vfilt_en;
    __u8 lpf_lo_en;
    __u8 lo_wgt_hfilt_en;
    __u8 lo_diff_hfilt_en;
    __u8 sig_hfilt_en;
    __u8 lo_detection_en;
    ...
    __u8 hiadj_sel;
    /* BAY3D_CTRL2 */
    __u8 cur_spnr_filter_en;
    __u8 cur_spnr_med_filter_en;
    __u8 pre_spnr_hi_filter_gic_en;
    __u8 pre_spnr_hi_filter_gic_enhance_en;
    __u8 spnr_presigma_use_en;
    __u8 pre_spnr_lo_filter_en;
    __u8 pre_spnr_hi_filter_en;
    __u8 baynr1_sigma_dbl_en;
    __u8 pre_spnr_hi_guide_filter_en;
    __u8 pre_spnr_sigma_idx_filt_en;
    ...
    __u16 lo_wgt_clip_pre_ds_min_limit;
    /* BAY3D_WGT1MAX */
